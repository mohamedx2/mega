        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <p>Add Project :</p>
              <Input type="text" value={name} variant="bordered" label="Project Name" onChange={(e)=>{setName(e.target.value)}} />
              <TimeInput label="Start Time" value={startTime} onChange={setStartTime} variant="bordered" placeholderValue={new Time(9)}/>
              <TimeInput value={endTime} label="End Time" variant="bordered" placeholderValue={new Time(9)} onChange={setEndTime}/>
              ...
              <ModalFooter>
                ...
                <Button className="bg-[#d15711] text-white text-md" onPress={()=>{editFunction(project.id,name,color,startTime,endTime);onClose()}}>
                  Edit Project
                </Button>
              </ModalFooter>
            </>
